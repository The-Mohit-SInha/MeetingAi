    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <motion.div
          ...
          className="lg:col-span-1 glass rounded-2xl p-4 shadow-xl h-fit"
        >
        ...
        <motion.div
          ...
          className="lg:col-span-3 glass rounded-2xl p-6 shadow-xl"
        >
          {/* Account Settings */}
          {activeSection === "account" && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">Manage your account preferences and regional settings</p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-white/60 rounded-xl">
                  ...
                  <button
                    ...
                    className={`relative w-14 h-7 rounded-full transition-colors ${
                      settings.autoSave ? "bg-gradient-to-r from-blue-500 to-purple-600" : "bg-gray-300"
                    }`}
                  >
                    <motion.div
                ...
                <div className="p-4 bg-white/60 rounded-xl space-y-3">
                  ...
                  <select className="w-full px-4 py-2 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500">
                ...
                {[
                  ...
                  >
                    ...
                    <button
                      ...
                      className={`relative w-14 h-7 rounded-full transition-colors ${
                        settings[item.key] ? "bg-gradient-to-r from-blue-500 to-purple-600" : "bg-gray-300"
                      }`}
                    >
                      <motion.div
          ...
          {activeSection === "appearance" && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">Customize how Meeting AI looks</p>
              </div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/60 rounded-xl space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center">
                      {theme === "dark" ? <Moon className="w-5 h-5 text-purple-600" /> : <Sun className="w-5 h-5 text-purple-600" />}
                    </div>
                    <div className="flex-1">
                ...
                {[
                  { key: "compactMode", label: "Compact Mode", desc: "Reduce spacing for more content", icon: Palette },
                  { key: "showAvatars", label: "Show Avatars", desc: "Display user avatars", icon: User },
                  { key: "animationsEnabled", label: "Animations", desc: "Enable smooth animations", icon: Zap },
                ].map((item, index) => (
                  <motion.div
                    key={item.key}
                    initial={{ opacity: 0, y: 10 }}
          ...
          {activeSection === "integrations" && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">Connect Meeting AI with your favorite tools</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <motion.div
                    ...
                    transition={{ delay: index * 0.05 }}
                    className="p-4 bg-white/60 rounded-xl"
                  >
