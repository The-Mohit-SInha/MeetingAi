...
-- 
-- INSTRUCTIONS:
-- 1. Go to: https://supabase.com/dashboard/project/qjrmxudyrwcqwpkmrggn
-- 2. Click "SQL Editor" in the left sidebar
-- 3. Click "New Query"
-- 4. Copy this entire file and paste it
-- 5. Click "Run" to execute
--
-- This will create all necessary tables, policies, and configurations.
-- ============================================================================
...
DROP POLICY IF EXISTS "Users can delete participants from their meetings" ON meeting_participants;
...
DROP POLICY IF EXISTS "Users can create their own action items" ON action_items;
...
-- Drop existing policies
DROP POLICY IF EXISTS "Service role can do anything" ON kv_store_af44c8dd;
...
-- Drop existing views
DROP VIEW IF EXISTS meeting_stats;
DROP VIEW IF EXISTS action_item_stats;
...
CREATE VIEW action_item_stats AS
SELECT
  user_id,
